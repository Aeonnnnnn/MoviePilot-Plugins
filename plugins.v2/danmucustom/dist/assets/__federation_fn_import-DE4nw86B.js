...
const moduleMap = {'vue':{get:()=>()=>__federation_import(new URL('__federation_shared_vue-0bcjoC7g.js', import.meta.url).href),import:true},'vuetify':{get:()=>()=>__federation_import(new URL('__federation_shared_vuetify-Bwr76qXI.js', import.meta.url).href),import:true},'vuetify/styles':{get:()=>()=>__federation_import(new URL('__federation_shared_vuetify/styles-D7aDDeDH.js', import.meta.url).href),import:true}};
